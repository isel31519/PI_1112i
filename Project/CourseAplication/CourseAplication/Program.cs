    ...
    class Program
    {
        internal class Loader
        {
            public static void FucRepoFill()
            {
                ...
                var f = new Fuc("Programaçao Orientada a Objectos", "POO", true, 6.0)
                            {
                                Prerequisites = "PG",
                                Semester = 2
                            };
                ...
                repo.Add(f);
                f = new Fuc("Programaçao", "PG", true, 6.0)
                {
                    Semester = 1
                };
                f.AddDescription("Objetivos", "Esta unidade curricular representa para a maioria dos alunos um primeiro contacto com a"+ 
